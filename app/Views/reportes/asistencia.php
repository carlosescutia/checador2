                ...
                <div class="ui grid">
                    <div class="row">
                        <div class="six wide column">
                            <h1 class="ui header">Asistencia por mes</h1>
                        </div>
                        <div class="six wide column">
                        ...
                        <div class="four wide column">
                            <div class="ui right aligned basic segment">
                                <a class="ui mini button" href="<?= site_url('reportes/asistencia/csv') ?>">Exportar</a>
            ...
            <div class="row">
                <div class="sixteen wide column">
                    ...
                    <?php foreach ($empleados as $empleados_item): ?>
                        <?php
                            $nom_mes = mktime(0,0,0, $mes, 10);
                        ?>
                        <div class="ui grey inverted segment">
                            <h3 class="ui header">
                                <?= $empleados_item['nom_empleado'] ?> - Asistencia de <?= ucfirst(datefmt_format($fmt_mes, $nom_mes)) ?> <?= $anio ?>
                            </h3>
                        </div>
                        <table id="tbl_asistencia" class="ui very basic striped unstackable table">
                                ...
                                <tr>
                                    ...
                                    <th>
                                        <h5 class="ui header">
                                            ...
                                            <div class="center aligned sub header"><?= $num_incidentes_empleado ?></div>
                                        </h5>
                                    </th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?= $incidentes_empleados_item['desc_corta_justificante'] ?> <?= $incidentes_empleados_item['desc_justificante'] ?></td>
                                </tr>
                                <?php endforeach ?>
                            </tbody>
                        </table>

                    ...
                    <form class="ui form" method="post" action="/eventualidad/guardar" id="frm_eventualidad">
                        <div class="fields">
                            <div class="eight wide field">
                                <label>Nombre</label>
                                <input type="text" name="nom_eventualidad" id="nom_eventualidad" value="<?=$eventualidad['nom_eventualidad']?>">
                            </div>
                        </div>
                        <input type="hidden" name="id_eventualidad" id="id_eventualidad" value="<?=$eventualidad['id_eventualidad']?>">

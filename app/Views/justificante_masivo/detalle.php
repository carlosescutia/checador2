                            ...
                            <div class="ui basic segment">
                                <form class="ui form" method="post" action="/justificante_masivo/guardar" id="frm_justificante_masivo">
                                    <div class="six wide field">
                                        ...
                                        <input type="date" name="fecha" id="fecha" value="<?= $justificante_masivo['fecha'] ?>">
                                    </div>
                                    <div class="six wide field">
                                        <label>Fecha final</label>
                                        <input type="date" name="fech_fin" id="fech_fin" value="<?= $justificante_masivo['fech_fin'] ?>">
                                    </div>
                                    <div class="six wide field">
                                        <label>Tipo</label>
                                        <div class="ui selection dropdown">
                                            <input type="hidden" name="tipo_cobertura" id="tipo_cobertura" value="<?= $justificante_masivo['tipo_cobertura'] ?>">
                                    ...
                                    <div class="controles-periodo">
                                        <div class="four wide field">
                                            <label>Periodo</label>
                                            <div class="ui selection dropdown">
                                                <input type="hidden" name="id_periodo_vacacional" value="<?= $justificante_masivo['id_periodo_vacacional'] ?>">
                                                <i class="dropdown icon"></i>
                                        ...
                                        <div class="four wide field">
                                            <label>Año</label>
                                            <input type="number" name="anio" id="anio" value="<?= $justificante_masivo['anio'] ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="fourteen wide field">
                                        <label>Detalle</label>
                                        <textarea name="detalle" id="detalle" rows="4"><?= $justificante_masivo['detalle'] ?></textarea>
                                    </div>
                                    <input type="hidden" name="id_justificante_masivo" value="<?= $justificante_masivo['id_justificante_masivo'] ?>">
                            ...
                            <div class="ui stackable grid">
                                ...
                                <div class="eight wide column">
                                    <?php foreach ($emp1 as $emp1_item): ?>
                                        <?php 
                                            $status_empleado = in_array($emp1_item['id_empleado'], $empleados_justificante_masivo) ? 'checked' : '';
                                        ?>
                                        <div class="ui checkbox">
                                            <input type="checkbox" value="" name="chk<?=$emp1_item['id_empleado']?>" <?= $status_empleado?> form="frm_justificante_masivo">
                                ...
                                <div class="eight wide column">
                                    <?php foreach ($emp2 as $emp2_item): ?>
                                        <?php 
                                            $status_empleado = in_array($emp2_item['id_empleado'], $empleados_justificante_masivo) ? 'checked' : '';
                                        ?>
                                        <div class="ui checkbox">
                                            <input type="checkbox" value="" name="chk<?=$emp2_item['id_empleado']?>" <?= $status_empleado?> form="frm_justificante_masivo">

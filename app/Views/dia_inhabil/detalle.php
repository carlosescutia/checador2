                ...
                <div class="ui basic segment">
                    <form class="ui form" method="post" action="/dia_inhabil/guardar" id="frm_dia_inhabil">
                        <div class="four wide field">
                            <label>Fecha</label>
                            <input type="date" name="fecha" id="fecha" value="<?= $dia_inhabil['fecha'] ?>">
                        </div>
                        <div class="ten wide field">
                            <label>Detalle</label>
                            <textarea name="detalle" id="detalle" rows="4"><?= $dia_inhabil['detalle'] ?></textarea>
                        </div>
                        <input type="hidden" name="id_dia_inhabil" id="id_dia_inhabil" value="<?= $dia_inhabil['id_dia_inhabil'] ?>">

...
class Reportes extends BaseController
{
    ...
    public function asistencia($salida='')
    {
        ...
        $incidentes = $this->incidente_model->get_incidentes_empleados($mes, $anio, $tolerancia_retardo, $tolerancia_asistencia, $salida);
        ...
        if ($salida == 'csv') {
            ...
            $num_incidentes = $this->incidente_model->get_num_incidentes_empleados($mes, $anio, $tolerancia_retardo, $tolerancia_asistencia);
    ...
    public function incidentes($salida='')
    {
        ...
        $incidentes = $this->incidente_model->get_incidentes_empleados_periodo($fech_ini, $fech_fin, $tolerancia_retardo, $tolerancia_asistencia, $salida);

        if ($salida == 'csv') {
            return $this->response->download("incidentes_" . $fech_ini . '_' . $fech_fin . '.csv', $incidentes);
        } else {
            $estado = 'activos';
            $empleados = $this->empleado_model->get_empleados($estado);

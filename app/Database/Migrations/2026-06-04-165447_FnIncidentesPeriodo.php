...
class FnIncidentesPeriodo extends Migration
{
    public function up()
    {
        $sql = ""
            ...
            ."returns table(id_empleado int, fecha date, hora_entrada time, hora_salida time, cve_tipo_incidente text) as "
            ."$$ "
            ."begin "
                ."return query "
            ." "
                ...
                .") "
                    ."select * from incidentes_salida ins where ins.cve_tipo_incidente is not null "
            ." "
                ."union "
            ." "
